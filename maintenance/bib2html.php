...
function get_existing_href() {
    ...
    $trees = json_decode(file_get_contents("https://api.github.com/repos/webis-de/downloads/git/trees/master", false, $context));
    $url = false;
...
<meta name="copyright" content="&copy; 2018 Webis" />
<title>Publications</title>
<link href="../css/webis.css" type="text/css" rel="stylesheet">
<link href="bibentry.css" type="text/css" rel="stylesheet">
...
<div id="search-control">
  <input type="text" id="search-field" oninput="filter()" placeholder="Type here to filter"/>
</div>
...
<!-- footer start -->
<!-- footer end -->
<script type="text/javascript" src="bibentry.js"></script>
</body>
</html>
